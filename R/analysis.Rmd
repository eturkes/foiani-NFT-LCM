...
# protein is not MNAR.
# --------------------------------------------------------------------------------------------
Neg_order <- order(rowMeans(assay(data)[ , which(data$condition == "Fraction.1")], TRUE))
data <- data[Neg_order, ]
Neg_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.1")], TRUE) < Neg_MNAR_cutoff)
)

Pos_order <- order(rowMeans(assay(data)[ , which(data$condition == "Fraction.1")], TRUE))
data <- data[Pos_order, ]
Pos_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.1")], TRUE) < Pos_MNAR_cutoff)
)
# --------------------------------------------------------------------------------------------
